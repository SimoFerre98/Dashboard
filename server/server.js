...
app.post('/api/files/:id', (req, res) => {
    ...
    if (req.body.bookmarks !== undefined) metadata[id].bookmarks = Array.isArray(req.body.bookmarks) ? req.body.bookmarks : [];
    if (req.body.linkedMedia !== undefined) metadata[id].linkedMedia = Array.isArray(req.body.linkedMedia) ? req.body.linkedMedia : [];
